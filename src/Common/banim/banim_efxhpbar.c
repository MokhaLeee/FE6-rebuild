...
void EfxHpBar_DeclineToDeath(struct ProcEfxHpBar *proc)
{
	...
	if (gEkrPids[GetAnimPosition(proc->anim_main_this)] == PID_IDUNN_DRAGON ||
        gEkrPids[GetAnimPosition(proc->anim_main_this)] == PID_FAE) {
...
void EfxNoDmage_Loop(struct ProcEfxHpBar *proc)
{
	...
	if (gEkrPids[GetAnimPosition(proc->anim_main_other)] == PID_IDUNN_DRAGON ||
        gEkrPids[GetAnimPosition(proc->anim_main_other)] == PID_FAE) {
