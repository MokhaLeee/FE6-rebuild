...
EWRAM_DATA i16 gBanimBG = 0;
EWRAM_DATA i16 gEkrInitialHitSide = 0;
EWRAM_DATA i16 gEkrSnowWeather = 0;
EWRAM_DATA i16 gBanimValid[2] = {};
EWRAM_DATA i16 gBanimPosIsTarget[2] = {};
EWRAM_DATA i16 gBanimIdx_bak[2] = {};
EWRAM_DATA i16 gBanimUniquePal[2] = {};
EWRAM_DATA i16 gBanimFactionPal[2] = {};
EWRAM_DATA i16 gEkrSpellAnimIndex[2] = {};
EWRAM_DATA i16 gBanimFloorfx[2] = {};
EWRAM_DATA i16 gEkrDistanceType = 0;
EWRAM_DATA i16 gEkrBmLocation[4] = {};
EWRAM_DATA i16 gAnimRoundData[20] = {};
EWRAM_DATA i16 gEfxHpLutOff[2] = {};
EWRAM_DATA u16 gEfxHpLut[22] = {};
EWRAM_DATA i16 gBanimIdx[2] = {};
...
EWRAM_OVERLAY(banim) int gEkrDebugFlag1 = 0;
EWRAM_OVERLAY(banim) int gEkrDebugFlag2 = 0;
EWRAM_OVERLAY(banim) int gAnimC01Blocking = 0;
EWRAM_OVERLAY(banim) i16 gEkrXPosReal[2] = {};
EWRAM_OVERLAY(banim) i16 gEkrYPosReal[2] = {};
EWRAM_OVERLAY(banim) u16 gEkrXPosBase[2] = {};
EWRAM_OVERLAY(banim) u16 gEkrYPosBase[2] = {};
EWRAM_OVERLAY(banim) struct Vec2i gEkrBg0QuakeVec = {};
EWRAM_OVERLAY(banim) void *gpBanimTerrainfxBufs[2] = {};
EWRAM_OVERLAY(banim) void *gpBanimTerrainTsaBufs[2] = {};
EWRAM_OVERLAY(banim) u16 *gpBanimTerrainPalBufs[2] = {};
EWRAM_OVERLAY(banim) u16 *gpEfxUnitPaletteBackup[2] = {};
...
static void EkrBattleDeamon_OnEnd(void)
{
	gBattleDeamonActive = FALSE;
	UnlockGame();
}

static void EkrBattleDeamonMain(ProcPtr proc) {}

static const struct ProcScr ProcScr_EkrBattleDeamon[] = {
...
static const struct ProcScr ProcScr_EkrBattle[] = {
